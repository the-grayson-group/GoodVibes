...
class ccData(object):
    ...
    Description of cclib attributes:
        ...
        solvation -- implicit solvation model used (Boolean)
    ...
    _attributes = {
       ...
       "molecular_mass":   Attribute(float,            'molmass',                     'properties'),
       "symmno":           Attribute(int,              'symmetry',                    'properties'),
       "point_group":      Attribute(str,              'point group',                 'properties'),

       "roconst":          Attribute(list,             'rotational constants',        'rotations'),
       "rotemp":           Attribute(list,             'rotational temperatures',     'rotations'),
       "cpu":              Attribute(list,             'CPU time',                    'N/A'),
       "linear_mol":       Attribute(bool,          'Is molecule linear',          'N/A'),
       ...
       "dgsolv":           Attribute(float,            'delta G solvation',           'optimization:scf'),
       ...
       "single_point_energy": Attribute(float,         'single point energy',         'optimization:scf'),

       "solvation":        Attribute(list,             'done',                        'N/A'),
